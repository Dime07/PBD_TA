                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">User</span><img class="border rounded-circle img-profile" src="{{ asset('img/avatars/asdads%20(2).jpg') }}" /></a>
                  ...
                  <div class="modal-body">
                    <div class="col-md-6">
                        <form method="POST" action="{{ route('karyawan.store')}}">
                            @csrf
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Nama" name="nama_lengkap" />
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Jabatan" name="jabatan"/>
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Asal" name="asal" />
                            <input type="text" class="border rounded-0 form-control" placeholder="Umur" style="margin-bottom: 15px;width: 440px;" name="umur" />
                            <input type="date" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Kontrak" name="kontrak" />
                            <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Gaji" name="gaji" />
            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Data Karyawan</p>
                    </div>
                    <div class="card-body">
                                          ...
                                          <div class="modal-body">
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('karyawan.update', $data['id'])}}">
                                                    @csrf
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Nama" name="nama_lengkap" value="<?=$data['nama_lengkap']?>" />
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Jabatan" name="jabatan" value="<?=$data['jabatan']?>"/>
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Asal" name="asal" value="<?=$data['asal']?>"/>
                                                    <input type="text" class="border rounded-0 form-control" placeholder="Umur" style="margin-bottom: 15px;width: 440px;" name="umur" value="<?=$data['umur']?>"/>
                                                    <input type="date" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Kontrak" name="kontrak" value="<?=$data['kontrak']?>"/>
                                                    <input type="text" class="border rounded-0 form-control" style="width: 440px;margin-bottom: 15px;" placeholder="Gaji" name="gaji" value="<?=$data['gaji']?>"/>
